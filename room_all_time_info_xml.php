    ...
    <div class="price_day_box">
		<ul class="price_day clearfix">
			...
			while($row = $result->fetch_assoc()){
				...
				$chk_sql = "SELECT * FROM hourbooked_list JOIN service_list ON service_list.service_id = hourbooked_list.service_id AND hourbooked_list.booked_date='$booked_date' AND service_list.service_id='$service_id' AND hourbooked_list.service_id='$service_id'";
    		...
    		<li>
				<div class="reser_button">
					<a class="bt1" href="http://rsvt.co.kr/rsvt_web/reser_order.html?p_id=millky&amp;r_id=6221&amp;year=2023&amp;month=11&amp;useStartDate=20231112" target="_blank">예약 가능
					</a>
				</div>		
			</li>
			<?php }} ?>
