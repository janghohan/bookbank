...
$bookingNumber = isset($_POST['bookingNumber']) ? $_POST['bookingNumber'] : '';
...
if($bookingServiceId<=3){
	$bookingSql = "SELECT * FROM booked_list JOIN account_number JOIN service_list ON booked_list.booking_number='$bookingNumber' AND booked_list.service_id = account_number.service_id AND booked_list.service_id = service_list.service_id";
}else{
	$bookingSql = "SELECT * FROM hourbooked_list JOIN account_number JOIN service_list ON hourbooked_list.booking_number='$bookingNumber' AND hourbooked_list.service_id = account_number.service_id AND hourbooked_list.service_id = service_list.service_id";
}
...
$sms['title'] = "예약진행중 [".$bookingRow['service_name']."]";
$sms['msg'] = $bookingText." ".$price." ";
$sms['receiver'] = $bookingRow['booked_contact'];
$sms['sender'] = "01024482207";
$sms['testmode_yn'] = "N";
$sms['msg_type'] = "LMS";
